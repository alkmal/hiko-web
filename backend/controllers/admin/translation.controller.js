...
exports.uploadMultipleTranslations = async (req, res) => {
  try {
    if (!req.file) {
...
exports.updateTranslationsOfSingleLanguage = async (req, res) => {
  try {
...
exports.downloadAllTranslationsCSV = async (req, res) => {
  try {
